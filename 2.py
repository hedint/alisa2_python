...
cities = {
    ...
    'париж': ['1652229/cb50b269d9df7a7dbef5', '213044/47e5b902264fec146028']
}
...
def get_help_text():
    return "Это игра Угадай Город! Ваша задача - правильно назвать город по фотографии, которую я вам покажу."
    ...
    if sessionStorage[user_id]['first_name'] is None:
        ...
        if not sessionStorage[user_id]['game_started']:
            ...
            if 'да' in req['request']['nlu']['tokens']:
                ...
                res['response']['text'] = get_help_text()
